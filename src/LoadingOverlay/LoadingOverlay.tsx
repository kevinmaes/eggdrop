      ...
      <div className="loading-overlay__content">
        <div className="loading-overlay__egg-container">
            ...
            >
              <defs>
                <g id="egg-shell-vector">
                  ...
                  >
                    <defs dangerouslySetInnerHTML={{ __html: EGG_FILL_GRADIENT }} />
                  </svg>
                </g>
                <rect id="egg-fill-rect" width={SVG_WIDTH} height={SVG_HEIGHT} />
                <g id={clipPathId.replace('#', '')}><path d={wavePath} /></g>
                <clipPath id={clipPathId}>
                  <path d={wavePath} />
                </clipPath>
                <linearGradient
                  id="egg-fill-gradient"
                  x1="0%"
                  y1="0%"
                  x2="100%"
                  y2="100%"
              ...
              <image
                href="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 40'><defs>${EGG_FILL_GRADIENT}</defs><rect width='30' height='40' fill='url(%23egg-fill-gradient)' /></svg>"
          ...
          <svg
            ...
            role="presentation"
            aria-hidden="true"
            dangerouslySetInnerHTML={{ __html: EGG_SHELL_SVG }}
          />
        </div>
