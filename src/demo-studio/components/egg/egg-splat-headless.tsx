    ...
    >
      ...
      >
        ...
        >
          ...
          <StateField
            ...
            value={`${Math.round(context.groundY - context.position.y - 60)}px`}
          />
        </div>
      ...
      >
        ...
        <ol style={{ margin: 0, paddingLeft: '20px' }}>
          ...
          <li>
            Watch the state transitions in real-time as the egg falls and splats
          </li>
          <li>States: Waiting → Falling → Landed → Splatting</li>
          <li>Context values update every frame during falling</li>
          <li>
