...
import eggHatchGameAccurateHeadlessMachine from '../../machines/egg/egg-hatch-game-accurate-headless.machine';
    ...
    >
      ...
      >
        ...
        <ol style={{ margin: 0, paddingLeft: '20px' }}>
          ...
          <li>
            This demo matches the actual game's egg.machine.ts state sequence
            exactly
          </li>
