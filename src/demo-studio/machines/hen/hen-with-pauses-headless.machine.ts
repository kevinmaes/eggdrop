 ...
 *
 * This is a version of hen-with-pauses.machine.ts with all Konva dependencies removed.
...
const henWithPausesHeadlessMachine = setup({
  types: {} as {
    input: {
      id: string;
  ...
  states: {
    ...
    'Reached Destination': {
      entry: ['flipDestination', 'pickPauseDuration'],
      after: {
        1000: {
          target: 'Pausing',
        },
...
export default henWithPausesHeadlessMachine;
