  ...
  return [
    {
      ...
      background: {
        ...
        color: '#2c5f7f',
        stageColor: '#8B7355',
        stageHeightPercent: 100 / canvasHeight,
      },
  ...
  return [
    {
      ...
      background: {
        ...
        color: '#2c5f7f',
        stageColor: '#8B7355',
        stageWidthPercent: 150 / canvasWidth,
      },
  ...
  return [
    {
      ...
      background: {
        ...
        color: '#2c5f7f',
        stageColor: '#8B7355',
        stageHeightPercent: chefCanvasHeight / chefCanvasHeight,
      },
  ...
  return [
    {
      ...
      background: {
        ...
        color: '#2c5f7f',
        stageColor: '#8B7355',
        stageWidthPercent: 150 / demoCanvasWidth,
      },
      layoutMode: 'horizontal-split-narrow',
      layoutOrientation: 'split-horizontal',
