...
/**
 * Hatched Chick Stand and Exit Component
 *
 * Shows chick sequence from hatched to exiting:
 * - Waiting/Hatching: chick-hatch (in shell on ground)
 * - Standing: chick-forward-1 (standing alone)
...
export function HatchedStandExit({
  actorRef,
}: {
  actorRef: ActorRefFrom<typeof hatchedStandExitMachine>;
}) {
  ...
  const isStanding = currentState === 'Standing';
  ...
  let frameName = 'chick-hatch.png'; // Default (waiting/hatching)
