 ...
 *
 * Creates a single inspector instance that can be reused across all stories.
 * When switching stories, we close and reopen the inspector window to ensure
 ...
 * This ensures the inspector shows only the new actor when switching stories.
 *
