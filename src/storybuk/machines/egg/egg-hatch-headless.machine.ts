...
/**
 * Headless Egg Hatch Machine - Complete Lifecycle Demo
 *
 * This is a version of egg-hatch.machine.ts with all React ref dependencies removed.
...
const eggHatchHeadlessMachine = setup({
  types: {} as {
    input: {
      id: string;
...
export default eggHatchHeadlessMachine;
export type EggHatchHeadlessActorRef = ActorRefFrom<
  typeof eggHatchHeadlessMachine
>;
